    ...
    <div className="space-y-4 sm:space-y-6 md:space-y-8 max-w-5xl mx-auto text-white">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
        <div className="bg-neutral-800/50 backdrop-blur-lg rounded-xl border border-white/10 overflow-hidden">
          <img 
            src={company.image || '/mobileapps/default/default.png'} 
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          {company.appOverview && (
            <div>
              <h2 className="font-bold text-sm sm:text-base md:text-lg mb-2">App Overview</h2>
              <p className="text-xs sm:text-sm text-gray-300">{company.appOverview}</p>
            </div>
          )}
          ...
          {company.appStatement && (
            <div>
              <h2 className="font-bold text-sm sm:text-base md:text-lg mb-2">App Statement</h2>
              <p className="text-xs sm:text-sm text-gray-300">{company.appStatement}</p>
            </div>
          )}
      ...
      {company.brandingImages?.length > 0 && (
