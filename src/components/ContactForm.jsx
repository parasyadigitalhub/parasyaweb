...
const ContactForm = () => {
  return (
    <section id="contact_form" className="py-12 md:py-24 bg-neutral-900 relative overflow-hidden mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="bg-neutral-800/50 backdrop-blur-lg rounded-2xl p-6 md:p-8 border border-white/10">
          ...
          <div className="bg-neutral-800/50 backdrop-blur-lg rounded-2xl p-6 md:p-8 border border-white/10">
            <form className="space-y-4 md:space-y-6">
              ...
              <div>
                ...
                <textarea
                  rows="4"
                  className="w-full bg-neutral-700/50 border border-white/10 rounded-lg px-3 md:px-4 py-2 text-white text-sm md:text-base focus:outline-none focus:border-red-600 transition-colors"
...
const ContactInfo = ({ title, description, iconPath }) => (
  <div className="flex items-start space-x-3 md:space-x-4">
    <div className="flex-shrink-0">
      <div className="p-3 md:p-4 bg-red-600/10 rounded-lg">
    ...
    <div>
      ...
      <p className="mt-1 text-sm md:text-base text-gray-300">{description}</p>
    </div>
  </div>
);
...
const InputField = ({ label, type, placeholder }) => (
  <div>
    <label className="block text-sm font-medium text-gray-300 mb-1.5 md:mb-2">{label}</label>
    <input
      type={type}
      className="w-full bg-neutral-700/50 border border-white/10 rounded-lg px-3 md:px-4 py-2 text-white text-sm md:text-base focus:outline-none focus:border-red-600 transition-colors"
...
const BackgroundEffects = () => (
  <div className="absolute inset-0 z-0 overflow-hidden">
    <div className="absolute top-1/4 left-1/4 w-48 md:w-96 h-48 md:h-96 bg-red-600/10 rounded-full filter blur-3xl animate-pulse"></div>
    <div className="absolute bottom-1/4 right-1/4 w-48 md:w-96 h-48 md:h-96 bg-red-900/10 rounded-full filter blur-3xl animate-pulse delay-1000"></div>
  </div>
);
