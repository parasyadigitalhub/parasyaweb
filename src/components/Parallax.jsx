    ...
    <div className="flex flex-col">
      ...
      >
        <div className="relative w-full max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-5xl flex justify-center items-center px-4 sm:px-8 md:px-12 lg:px-20">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-1 sm:left-4 md:left-8 top-1/2 -translate-y-1/2 p-1.5 sm:p-2 rounded-full bg-white/80 text-gray-800 hover:bg-white transition-all duration-200 shadow-md z-10 hidden sm:block"
          >
            <ChevronLeft />
          </button>
          <button
            onClick={nextSlide}
            className="absolute right-1 sm:right-4 md:right-8 top-1/2 -translate-y-1/2 p-1.5 sm:p-2 rounded-full bg-white/80 text-gray-800 hover:bg-white transition-all duration-200 shadow-md z-10 hidden sm:block"
          >
            <ChevronRight />
          </button>
        </div>
      ...
      <div className="flex justify-center gap-6 py-4 sm:hidden">
        <button
          onClick={prevSlide}
          className="p-2 rounded-full bg-white text-gray-800 hover:bg-gray-100 transition-all duration-200 shadow-md"
        >
          <ChevronLeft />
        </button>
        <button
